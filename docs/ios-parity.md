...
| RAD-06 | Full player shows source, artwork, title/artist or ICY title, format data, status, favorite/shuffle actions, queue access, and transport. Match portrait and landscape layouts and long-text treatment. | W | —/—/— | 2026-09-16: player with source line, art plate (real cover or caption/plate), ICY stream title via a tested parser on a second metadata connection, left-aligned meta, status, buffered readout, favourite and transport (`3753476`, `32059f2`, `05646b0`); format data, shuffle, queue count/access, landscape split and long-text marquee pending. |
...
| RAD-09 | Artwork loads after playback begins. Match provider/local/radio artwork selection, letterboxing, cliamp channel treatment, and fallback plates; failed or slow art must not delay audio. | R | —/—/— | 2026-09-16: og:image → apple-touch-icon → favicon discovery with a 64 KB scrape cap, ImageIO-scaled decodes, a seven-day disk cache and 60-second miss backoff; rows, tiles, mini player and the player plate live, cliamp channels keep the generated plate (`32059f2`). Observed in the simulator with real directory artwork; square-fill versus wordmark-letterbox rule ported, device review pending. |
